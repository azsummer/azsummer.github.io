...
(function () {
    ...
    hm.src = "https://hm.baidu.com/hm.js?6af7ccc1f9a953fd3a5641e9a439803f";
...
$(document).ready(function () {
    ...
    $(".banner-weibo, .insstall-cont").click(function () {
        window.location.href = "https://www.coolapk.com/apk/com.suihan.version4";
    });

    $(".ime-update").click(function () {
        window.location.href = "https://www.coolapk.com/apk/com.suihan.version3";
    });
...
//点赞
function likeskin() {
    var msg = ["呵呵", "^_^你已坚定地赞过!", "_^后悔点赞了么？", "^_后悔也没用了呀~", "^V^其实是我太懒没加取消点赞功能~", "^:^悲催鸟,要跳转到官网了……"];
    var likeTime = 1;
    ...
    $(".like").click(function () {
        if ($.cookie(skinID) != 1) {
            ...
            if (likeTime > 4) {
                ...
                window.location.href = "http://suihaninput.sxl.cn/";
            } else {
                if (isApp()) {
    ...
    $(".skin-download").click(function () {
        ...
        if (isIME()) {
            ...
            if (beta || hide) {
                ...
                window.location.href = "http://suihaninput.sxl.cn/" + skinID;
            }
    ...
    if (isIME()) {
        ...
        $(".share-wxf").click(function () {
            ...
            exec("imeExtendComponents", 'share_mm_friend', [name, description, url, imgs[0], imgs[1], {
                'sharesuccesspageUrl': 'https://1005584676.github.io/skins/index.html'
                }]);
            $(".shade").hide();
            $("#share-win").slideToggle(200);
